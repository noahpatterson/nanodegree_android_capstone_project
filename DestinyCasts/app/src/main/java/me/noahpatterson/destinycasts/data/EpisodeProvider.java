...
public class EpisodeProvider extends ContentProvider {
    ...
    private static final String LOG_TAG = EpisodeProvider.class.getSimpleName();
    private static final UriMatcher sUriMatcher = buildUriMatcher();
    private EpisodeDBHelper mOpenHelper;

    // Codes for the UriMatcher //////
    private static final int EPISODE = 100;
    private static final int EPISODE_WITH_ID = 200;
    ////////
    ...
    public boolean onCreate(){
        mOpenHelper = new EpisodeDBHelper(getContext());
